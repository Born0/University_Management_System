...
class AdminRepo
{
    ...
    function Insert(Admin $admin)
    {
        ...
        $sql = "INSERT INTO Users(name,email,dob,gender,bloodgroup,contact_number,address,religion,join_date,salary,password,image)
VALUES("."'". $admin->getName() . "','" . $admin->getEmail() . "','" . $admin->getDob() . "',
	...
	*/
    function Get(Admin $admin)
    {
        ...
        $sql2 = "SELECT * FROM users WHERE email='" . $admin->getEmail() .  "'";
