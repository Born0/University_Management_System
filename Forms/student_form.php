...
<html>
	<body>
		<?php
			...
			$studentId=$name=$dob=$gender=$country=$city=$address=$admissionDate=$bloodgroup="";
			$error="";
		  ...
		  {
			  global $name,$studentId,$dob,$gender,$country,$city,$address,$admissionDate,$bloodgroup;
			  if($studentId==""||$name==""||$dob==""||$gender==""||$country==""||$city==""||$address==""||$admissionDate==""||$bloodgroup=="")
				  return true;
			  else return false;
		  }
			...
			<form action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?> method="post">
				 ...
				 <table style="width:20%" align="center">
					  <tr>
						...
						<td>: <input type="text" id="studentId" name="studentId" value="<?php echo $studentId;?>"></td><br>
					  </tr>
					  ...
					  <tr>
					   ...
					   <tr>
						...
						<tr>
							...
							<td>: <input style="font-size: 1rem" type="date" id="admissionDate" name="admissionDate" value="<?php echo $admissionDate;?>"></td>
					   </tr> 
