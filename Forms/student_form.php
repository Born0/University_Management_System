...
<html>
	<body>
		<?php
			...
			$studentId=$name=$dob=$gender=$country=$city=$email=$address=$admissionDate=$bloodgroup="";
			$error="";
		  ...
		  {
			  global $name,$studentId,$dob,$gender,$country,$city,$address,$admissionDate,$bloodgroup,$email;
			  if($studentId==""||$name==""||$dob==""||$gender==""||$country==""||$city==""||$address==""||$admissionDate==""||$bloodgroup==""||$email==""||$password=="")
				  return true;
			  else return false;
		  }
